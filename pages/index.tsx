...
const Home: NextPage = () => {
  return (
    ...
    <SimpleGrid id='about' cols={2} px={64} py={64} sx={theme=>({backgroundColor:theme.colors.gray[5]})}>
      <Center>
        <Stack align='center'>
    ...
    <SimpleGrid id='posibilities' spacing='xl' cols={2} py={64} px={64}>
      <Stack align='center'>
    ...
    <Box id='info' px={64} py={32} sx={theme=>({backgroundColor:theme.colors.gray[5], display: 'flex', gap: 16})}>
